...
replace (
	github.com/grafana/grafana-openapi-client-go v0.0.0-20240215164046-eb0e60d27cb7 => github.com/romanfurst/grafana-openapi-client-go v0.0.0-20240508180043-0d986d29ee4e
